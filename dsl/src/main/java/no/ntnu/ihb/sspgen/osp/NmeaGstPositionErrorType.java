...
/**
 * This group contains exactly 3 variables representing the sigma errors for latitude, longitude and altitude of an NMEA GST message. The contained variables represent the following:
 ...
 *
 * <p>Java class for NmeaGstPositionErrorType complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="NmeaGstPositionErrorType">
 *   &lt;complexContent>
...
@XmlType(name = "NmeaGstPositionErrorType", namespace = "https://open-simulation-platform.com/OspModelDescription/1.0.0", propOrder = {
        "variable"
})
public class NmeaGstPositionErrorType {
