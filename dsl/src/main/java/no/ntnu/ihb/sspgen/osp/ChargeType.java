...
/**
 * Variables grouped under this element is defined to represent an electric charge. The xml schema validates the number of contained Variable elements, and the OSP-IS validator checks that the causalities are correct.
 *
...
@XmlType(name = "ChargeType", namespace = "https://open-simulation-platform.com/OspModelDescription/1.0.0", propOrder = {
        "variable"
})
