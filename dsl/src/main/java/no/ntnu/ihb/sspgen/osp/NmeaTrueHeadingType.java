...
/**
 * This group contains exactly 1 variable which represents heading in degrees (true North) for an NMEA THS message
 *
...
@XmlType(name = "NmeaTrueHeadingType", namespace = "https://open-simulation-platform.com/OspModelDescription/1.0.0", propOrder = {
        "variable"
})
