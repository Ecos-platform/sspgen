...
public class TSignalDictionaries {
    ...
    protected List<SignalDictionary> signalDictionary;
     ...
     * {@link SignalDictionary }
     *
     *
     */
    public List<SignalDictionary> getSignalDictionary() {
        if (signalDictionary == null) {
            signalDictionary = new ArrayList<SignalDictionary>();
        }
