...
/**
 * Variables grouped under this element is defined to represent a angular velocity. The xml schema validates the number of contained Variable elements, and the OSP-IS validator checks that the causalities are correct.
 *
